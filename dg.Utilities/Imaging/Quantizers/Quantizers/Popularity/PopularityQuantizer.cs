...
using dg.Utilities.Imaging.Quantizers.ColorCaches;
using dg.Utilities.Imaging.Quantizers.ColorCaches.Octree;
using dg.Utilities.Imaging.Quantizers.Helpers;

namespace dg.Utilities.Imaging.Quantizers.Popularity
{
    /// <summary>
    ...
    public class PopularityQuantizer : BaseColorCacheQuantizer
    {
        ...
        protected override List<Color> OnGetPaletteToCache(Int32 colorCount)
        {
            ...
            List<Color> colors = new List<Color>(orderedColorMap.Count);
