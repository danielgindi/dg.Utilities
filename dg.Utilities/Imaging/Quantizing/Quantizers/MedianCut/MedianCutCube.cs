...
using dg.Utilities.Imaging.Quantizers.ColorCaches.Common;
using dg.Utilities.Imaging.Quantizers.Helpers;

namespace dg.Utilities.Imaging.Quantizers.MedianCut
{
    /// <summary>
    ...
    internal class MedianCutCube
    {
        ...
        public void SplitAtMedian(Byte componentIndex, out MedianCutCube firstMedianCutCube, out MedianCutCube secondMedianCutCube)
        {
            ...
            switch (componentIndex)
            {
                // red colors
                case 0:
                    colors = new List<int>(colorList);
                    colors.Sort((int argb1, int argb2) => {
                        return ColorModelHelper.GetComponentA(ColorModel, Color.FromArgb(argb1)).CompareTo(ColorModelHelper.GetComponentA(ColorModel, Color.FromArgb(argb2)));
                    });
                    break;
                ...
                case 1:
                    ...
                    colors.Sort((int argb1, int argb2) =>
                    {
                        return ColorModelHelper.GetComponentB(ColorModel, Color.FromArgb(argb1)).CompareTo(ColorModelHelper.GetComponentB(ColorModel, Color.FromArgb(argb2)));
                    });
                    break;
                ...
                case 2:
                    ...
                    colors.Sort((int argb1, int argb2) =>
                    {
                        return ColorModelHelper.GetComponentC(ColorModel, Color.FromArgb(argb1)).CompareTo(ColorModelHelper.GetComponentC(ColorModel, Color.FromArgb(argb2)));
                    });
                    break;
